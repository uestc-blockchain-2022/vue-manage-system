	...
	<div>
		<div class="container">
			...
			<el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
				<el-table-column prop="id" label="贷款合同号" width="55" align="center"></el-table-column>
				...
				<el-table-column label="状态" align="center">
					<template #default="scope">
						<el-tag
							:type="scope.row.state === '已还款' ? 'success' : scope.row.state === '未还款' ? 'danger' : scope.row.state 
							=== '待审核' ? 'warning' : scope.row.state === '待还款' ? 'warning' : ''"
						>
							{{ scope.row.state }}
						</el-tag>
					</template>
